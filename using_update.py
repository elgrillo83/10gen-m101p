...
# performs a wholesale replacement of document
def using_update():
  print "updating record using update"

  # get a handle to the scool database
  db = connection.school
  scores = db.scores
  ...
  try:
    ...
    # update the record with update. Note that there is an _id but DB is ok
    # with that because it matches what was there
